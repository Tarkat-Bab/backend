import { Body, Controller, HttpCode, Param, Patch, Post, Query, Req } from '@nestjs/common';
...
export class AuthController {
  ...
  @Patch('/register-technical')
  @ApiHeader({
    name: 'Accept-Language',
    description: 'Language for the response (e.g., ar, en)',
    required: false,
  })
  async technicalCompleteRegister(@Body() registerDto: TechnicalRegisterDto, @Language() lang: LanguagesEnum) {
